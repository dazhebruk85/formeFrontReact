...
export default class RoomExcludeObjectEditForm extends Component {
    ...
    okAction() {
        let excludeObjectData = this.state.fields;
        let errors = [];
        ...
        if (errors.length > 0) {
            ...
            setTimeout(() => this.okActionParent(excludeObjectData), 0);
            this.closeModal()
        }
    }

    chooseExcludeObjectType(selected){
        if (selected) {
            this.setState({
                fields: {
                    ...this.state.fields,
                ...
                <VerticalPanel>
                    ...
                    <HorizontalPanel>
                        ...
                        <DictField width='300px'
                                   ...
                                   maxLength={100}
                                   context={Const.ROOM_EXCLUDE_OBJECT}
                                   chooseDictAction={this.chooseExcludeObjectType.bind(this)}
